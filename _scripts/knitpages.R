...
# with further explanation about process here:
#   http://varianceexplained.org/pages/workflow/ 

# run ./knitpages.R to update all knitr files that need to be updated.
# Rscript _scripts/knitpages.R
...
knit_folder("_R", "_posts/blog", "figs/", "_caches/")
