...
```{r animated-map-of-US-states, echo=FALSE, fig.width = 10, fig.show="animate"}
...
```{r animated-map-of-US-counties, echo=FALSE, fig.show="animate", cache.lazy=FALSE}
# specify dates for which historic map data is to be gathered
...
```{r ref.label="animated-map-of-US-states", echo=TRUE, eval=FALSE}
```

### County-level map
```{r ref.label="animated-map-of-US-counties", echo=TRUE, eval=FALSE}
```
